 ...
 <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
  ...
  <div class="menu_section">
    ...
    <h3> <?php 
     ...
     <li><a href="alan.php"><i class="fa fa-server"></i> Çalışma Alanları<span class="label label-success pull-right"></span></a></li>



         <li><a href="referans.php"><i class="fa fa-code-fork"></i> Kadro İşlemleri<span class="label label-success pull-right"></span></a></li>
